        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="d-lineas">
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="linea-estrella.html"><i class="fas fa-circle estrella"></i>Estrella</a></li>
                        </ul>
                ...
                <div class="col-lg-9 col-md-6">
                    <div style="background-image: url(images/bg-linea-estrella.jpg); " class="d-banner-linea valign" data-overlay-dark="3">
                        <span class="t1">LÍNEA</span>
                        <span class="t2">Estrella</span>
                    </div>
