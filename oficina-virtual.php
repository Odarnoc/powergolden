                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-lg-5 col-md-5 offset-lg-2 offset-md-2">
                                                <div class="card d-item-mision">
                                                    <center>
                                                        <a class="btn btn-blue mt-3" style="width: 80%; padding: 1rem;font-size: 14px;" href="promos.php" role="button">Ver promociones</a>
                                                        <a class="btn btn-blue mt-3" style="width: 80%; padding: 1rem;font-size: 14px;" href="promos.php" role="button">Ver paquetes</a>
                                                        <a class="btn btn-blue mt-3" style="width: 80%; padding: 1rem;font-size: 14px;" href="promos.php" role="button">Historial</a>
