...
<body class="body-dash-pos">
                ...
                <div class="col-lg-8 col-md-10">
                    <div class="d-ticket">
                        ...
                        <div class="d-info-top">
                            ...
                            <p class="t1">Fecha: <b id="fecha_ticket">30/11/2020 13:12 PM</b>
                            </p>
                            <p class="t1">Vendedor: <b><?php echo $_SESSION['username']?></b>
                            </p>
                            <p class="t1">Sucursal: <b id="sucursal">Brayam Morando</b></p>
                            <div id="horas_div" style="display:none;">
                                <p class="t1">Horas aplicadas: <b id="horas">Brayam Morando</b>
                                </p>
                            </div>
    ...
    <div class="modal fade" id="modalCorte" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-4" style="display:none;">
                            <button type="button" class="btn btn-lg-modal btn-pago-tarjeta" data-toggle="modal"
                                data-target="#modalTarjeta"><i class="fas fa-credit-card mr-2"></i> Pago con T.
                                Electronica</button>
                        </div>
                        <div class="col-lg-6 col-md-6 col-6">
                            <button type="button" class="btn btn-lg-modal" onclick="corte_parcial();"><i
                                    class="fas fa-credit-card mr-2"></i> Corte Parcial</button>
                        </div>
                        <div class="col-lg-6 col-md-6 col-6">
                            <button type="button" class="btn btn-lg-modal" onclick="corte_diario();"><i
                                    class="fas fa-coins mr-2"></i> Corte Diario</button>
                        </div>
    ...
    <div class="modal fade" id="modalHoras" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
