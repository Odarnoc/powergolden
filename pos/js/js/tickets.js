var usuario="";
function printMyImage(ticket,total) {
	var image = new Image();
...
function() {
	//alert("Me la pele");
	printSomeTestText(ticket,total);
...
function(Error) {
  ...
  return value.toString();
	...
	function printSomeTestText(ticket,total) {
		//printMyImage();
	...
	function imprimir_ticket(ticket,total,user=""){
		usuario=user;
		console.log(usuario);
