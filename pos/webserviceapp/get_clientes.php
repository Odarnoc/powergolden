...
if($_POST['tipo']==0){
	...
	THEN SUM(p.id) ELSE 0 END as compras,facturacion, rfc, nombrecomercial, numeroexterior, municipio, i.estado, pais from usuarios as u 
	...
	GROUP BY u.id,u.nombre,u.apellidos,u.telefono,u.correo,facturacion, rfc, nombrecomercial, numeroexterior, municipio, estado, pais");
}
