                        ...
                        <div class="row">
                            <div class="col-lg-10 col-md-10">
                                <div class="d-title-cuenta">
                                    ...
                                    <p class="small-text-cuenta">Registra las direcciones para tus envios.</p>
                                </div>
                            </div>
                                ...
                                <div class="d-form-tarjetas">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-5 offset-lg-2 offset-md-2">
                                            ...
                                            <p class="sub-title-cuenta">Mis direcciones</p>

                                        <?php foreach ($direccion as $item) { ?>
                                            <div style="margin-top: 1rem" type="radio">
                                                <div>
                                                    <div class="col">
                                                        <p class="t3"><?php echo ($item['direccion'])?></p>
                                                    </div>
                                                </div>
                                                <div class="row mt-10">
                                                    <div class="col-lg-6 col-md-6 col-6 d-btn-eliminar-tarjeta">
                                                        <a class="btn btn-eliminar-tarjeta"  role="button" data-toggle="modal" onclick="eliminar('<?php echo $item['id'] ?>')" data-target="#exampleModalCenter">Eliminar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?> 
