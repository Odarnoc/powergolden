                                    ...
                                    <form id="form-roles" class="form-registro-productos" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="floating-label-group">
                                                <input id="nombre" type="text" class="form-control input-form-underline" required value="<?php echo $rol->nombre; ?>" />
                                        ...
                                        <div class="form-group">
                                            <div class="floating-label-group">
                                                <input id="descripcion" type="text" class="form-control input-form-underline" required value="<?php echo $rol->descripcion; ?>"/>
                                            ...
                                            ?>
                                                <div class="form-group col-lg-6 col-md-6 col-6">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" name="menus" <?php if($item['checked'] == 1) {echo 'checked';} ?> type="checkbox" id="checkbox<?php echo $item['id']; ?>" value="<?php echo $item['id']; ?>">
