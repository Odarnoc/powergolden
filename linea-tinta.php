        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="d-lineas">
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="linea-tinta.html"><i class="fas fa-circle tinta"></i>Tinta</a></li>
                ...
                <div class="col-lg-9 col-md-6">
                    <div style="background-image: url(images/bg-linea-tinta.jpg); " class="d-banner-linea valign" data-overlay-dark="3">
                        <span class="t1">LÍNEA</span>
                        <span class="t2">Tinta</span>
                    </div>
                            ...
                            <div class="d-item-pro h-100">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <div class="d-img-pro">
                                            <img src="images/productos/linea-tinta/ar.jpg" alt="">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-8">
                                        <div class="d-info-pro">
                                            <p class="t1 tinta">Línea Tinta</p>
                                            <p class="t2">AR</p>
