                            ...
                            <form id="form-login-oficina" class="form-login">
                                <div class="form-group">
                                    <div class="floating-label-group">
                                        <input type="text" class="form-control input-form"  id="email" name="correo" />
                                ...
                                <div class="form-group">
                                    <div class="floating-label-group">
                                        <input type="password" class="form-control input-form"  id="pass" name="contra" />
                            ...
                            <div class="d-footer-form">
                                <div class="row row-links-form">
                                    <div class="col-lg-6 col-md-6">
                                        <p class="t4" style="text-align: left"><a href="registro-cliente.php" class="btn-link">Registrarme como cliente.</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
