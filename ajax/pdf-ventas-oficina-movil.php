...
if (isset($_GET['inicio']) && isset($_GET['fin'])) {
    ...
    $query = 'SELECT * FROM ventascliente WHERE user_id ="' . $_GET["user_id"] . '" and fecha BETWEEN "' . $_GET['inicio'] . '" and "' . $_GET['fin'] . '"';

} else {

    $query = 'SELECT * FROM ventascliente WHERE user_id ="' . $_GET["user_id"] . '"';
...

{
...

    {
        ...
        $usuario = R::findOne('usuarios','WHERE id = ?', [$_GET["user_id"]]);
