<?php
    ...
    $information  = R::getAll('SELECT YEAR(fecha) as anio, MONTH(fecha) as mes, COUNT(*) as ventas FROM ventascliente WHERE user_id ='.$_SESSION["user_id"].' GROUP BY YEAR(fecha), MONTH(fecha) LIMIT 4');
