                                    ...
                                    <form action="reporte-venta-oficina.php" method="post" class="form-reporte">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-lg-4 col-md-4">
                                                ...
                                                <a type="button" style="margin-top: 0rem!important; height: 37px;" href="pdf-usuario-sucursal.php<?php if (isset($_POST['fechauno'])&&isset($_POST['fechados'])){ ?>?inicio=<?php echo $_POST['fechauno'] ;  ?>&fin=<?php echo $_POST['fechados'] ; }?>" target="_blank" class="btn btn-blue mt-2"><i class="fas fa-arrow-circle-down mr-2"></i>Generar reporte</a>
                                            </div>
