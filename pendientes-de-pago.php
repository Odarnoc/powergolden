...
if(!isset($_POST['fecha-in'])){
    $query = 'SELECT v.*,r.referencia, u.nombre as nombre, u.apellidos as apellido from ventas as v 
    LEFT JOIN usuarios as u on v.user_id = u.id
    LEFT JOIN referencias_oxxo as r on v.id = r.venta_id
    WHERE v.is_payed=0';
    $filtro = "dd-mm-aaaa";
}else{
    $query = "SELECT v.*,r.referencia, u.nombre as nombre, u.apellidos as apellido from ventas as v 
    LEFT JOIN usuarios as u on v.user_id = u.id 
    LEFT JOIN referencias_oxxo as r on v.id = r.venta_id
    where v.is_payed=0 AND  DATE(fecha)=DATE('".date("Y-m-d", strtotime($_POST['fecha-in']))."')" ;
                    ...
                    <div class="d-cont-right">
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="d-title-cuenta">
                                    <p class="title-cuenta">Pendientes de pago.</p>
                                    <p class="small-text-cuenta">Busca tus ventas por fecha:  
                                        <form action="referencias.php" method="post">
                                            ...
                                            <a class="btn btn-aceptar-modal" style="color: white" href="pendientes-de-pago.php" >Limpiar filtro<i style="margin-left: 20px" class="fas fa-search"></i>
                                            </a>
                                        </form>  
                                    </p> 
                                </div>
                        ...
                        <table class="table" style="text-align:center">
                            <thead class="table-primary">
                                ...
                                <th scope="col">Referencia de oxxo</th>
                            ...
                            foreach ($ventas as $item) { ?>
                                ...
                                <td><?php echo ($item['sucursal_id']!=0) ?  "Pago Externo en POS":"Pago de E-Commerce" ;  ?></td>
