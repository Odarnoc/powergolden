        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="d-lineas">
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="linea-amarilla.html"><i class="fas fa-circle amarilla"></i>Amarilla</a></li>
                ...
                <div class="col-lg-9 col-md-6">
                    <div style="background-image: url(images/bg-linea-amarilla.jpg); " class="d-banner-linea valign" data-overlay-dark="3">
                        <span class="t1">LÍNEA</span>
                        <span class="t2">Amarilla</span>
                    </div>
